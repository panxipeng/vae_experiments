% This script aims to automatically extract the nucleis from the test
...
csvwrite('test_nucleis_data_original.dat',nucleis_data(2:end,:));
csvwrite('test_nucleis_data.dat',nucleis_data(2:10001,:));

% save workspace
save('test_pos_data_workspace')
