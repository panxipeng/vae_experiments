...
encoder.save('Compiled/variationalAutoencoders_noKL_encoder.h5')
vae.save('Compiled/variationalAutoencoders_noKL_autoencoder.h5')

# Save history
ae_history = np.array(vae_history.history['loss'])
np.savetxt('history_vA_noKL.csv', ae_history, delimiter=',')
