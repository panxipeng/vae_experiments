...
z_mean = Dense(latent_dim)(encoded_l3)
z_log_var = Dense(latent_dim)(encoded_l3)
...
encoder.save('Compiled/variationalAutoencoders_stacked_noLayerwise_encoder.h5')
vae.save('Compiled/variationalAutoencoders_stacked_noLayerwise_autoencoder.h5')

# Save history
ae_history = np.array(vae_history.history['loss'])
np.savetxt('history_vAs_noLayerwise.csv', ae_history, delimiter=',')
